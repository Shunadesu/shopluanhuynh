...
export default function NotificationModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-lg bg-dark-lighter rounded-2xl shadow-2xl overflow-hidden animate-fadeIn">
        {/* Close button */}
        {currentNotification.dismissible && (
          <button
            onClick={handleDismiss}
            className="absolute top-4 right-4 z-10 p-2 bg-dark/50 hover:bg-dark rounded-full transition-colors"
          >
